...
See [`Get started`](https://yharigaya.github.io/detectgxt/detectgxt.html) and [`Reference`](https://yharigaya.github.io/detectgxt/reference/index.html) for usage instructions.
...
See [`Get started`](https://yharigaya.github.io/detectgxt/detectgxt.html) for the format of input data.
